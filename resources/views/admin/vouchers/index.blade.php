...
<div class="admin-actions">
    <div>
        <div class="admin-page-title">Gift Vouchers</div>
        <div class="admin-page-subtitle">
            Manage issued vouchers
        </div>
    </div>
...
<span class="admin-badge admin-badge-{{ $status }}">
    ...
    @if($voucher->status === \App\Enums\VoucherStatus::UNUSED)

        {{-- Download QR --}}
        <a href="{{ route('admin.vouchers.download-qr', $voucher) }}"
        ...
        {{-- Invalidate --}}
        <form action="{{ route('admin.vouchers.revoke', $voucher) }}"
              method="POST"
              style="display:inline">
            @csrf
            <button class="admin-btn admin-btn-sm admin-btn-danger"
                    onclick="return confirm('Invalidate this voucher?')">
                🚫 Invalidate
            </button>
        </form>
